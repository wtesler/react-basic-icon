 ...
 */
var SignedIcon = function SignedIcon(props) {
  var signedUrl = props.signedUrl,
      src = props.src;
  ...
  var _useState3 = (0, _react.useState)(null),
      ...
      internalSrc = _useState4[0],
      setInternalSrc = _useState4[1];

  var BLANK_IMAGE = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";
  var controllerRef = (0, _react.useRef)(new AbortController());
  ...
  var loadImage = (0, _react.useCallback)( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(signedUrl) {
  ...
  return /*#__PURE__*/_react["default"].createElement(_Icon["default"], {
    id: state.id,
    className: "".concat(state.className),
